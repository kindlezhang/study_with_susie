...
* Terminal - Tool that you use to type and execute commands.
* Command Line - The interface of the terminal.
* The Shell - The program that the terminal runs. The "OS" of the terminal.

> bash or zsh are common shells for Linux or Unix 
> 
> CMD.exe is common shell for Windows, powershell is also provided
> 
> a lot of Unix-based solution for Windows including Git Bash and 
...
- `Ctrl + L`: Will clear the screen (or clear)
